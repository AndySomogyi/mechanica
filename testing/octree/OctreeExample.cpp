...
class OctreeExample: public Platform::GlfwApplication {
    public:
...
OctreeExample::OctreeExample(const Arguments& arguments) : Platform::GlfwApplication{arguments, NoCreate} {
