...
class Growth1: public Platform::GlfwApplication {
    public:
        explicit Growth1(const Arguments& arguments);
...
Growth1::Growth1(const Arguments& arguments):
...
void Growth1::mousePressEvent(MouseEvent& event) {
...
void Growth1::mouseReleaseEvent(MouseEvent& event) {
...
void Growth1::mouseMoveEvent(MouseMoveEvent& event) {
