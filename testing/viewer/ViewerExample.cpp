...
class ViewerExample: public Platform::GlfwApplication {
    public:
...
ViewerExample::ViewerExample(const Arguments& arguments): Platform::GlfwApplication{arguments, Configuration{}.setTitle("Magnum Viewer Example")} {
    ...
    //std::unique_ptr<Trade::AbstractImporter> importer{new Magnum::Trade::ObjImporter()};
...
int main(int argc, char** argv) {
    ...
    Magnum::Examples::ViewerExample app({argc, argv});
    return app.exec();
}
