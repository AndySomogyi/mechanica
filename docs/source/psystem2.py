...
class ParticleTypeA(m.Particle):
    pass
...
m.forces.Coulomb(0.01, type(ParticleTypeA), type(ParticleTypeA))
...
m.forces.BoidsCohesion(cutoff=20, k=0.5, type(ParticleTypeA))
...
m.forces.BoidsAlignment(cutoff = 20, k=0.24, type(ParticleTypeA))



# create a rendering window and renderer
# the visible window is a generic output device
win = m.VisibleWindow(width=640, height=480)
